...
function PhoneIcon(){return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.2 3.5 9.8 8l-2 2c1.1 2.5 3.7 5 6.2 6.2l2-2 4.5 2.6-1.1 3.1c-.3.8-1.1 1.3-2 1.2C10.1 20.4 3.6 13.9 2.9 6.6c-.1-.9.4-1.7 1.2-2l3.1-1.1Z"/></svg>}
...
export default function PaidCorporateLanding({courses}:Props){
  ...
  return <main className="pct-page">
    <header className="pct-header"><Link href="/" aria-label="Entrepôt Training Institute home"><img src="/entrepot-logo-transparent.png" alt="Entrepôt Training Institute"/></Link><div className="pct-header-actions"><div className="pct-header-contact"><a href="tel:+971544177480"><PhoneIcon/><span>+971 544 177480</span></a><a href="tel:+971545353558"><PhoneIcon/><span>+971 545 353 558</span></a></div><nav className="pct-header-socials" aria-label="Entrepôt social media">{socialLinks.map(([name,url])=><a href={url} target="_blank" rel="noopener noreferrer" aria-label={`Visit ETI on ${name}`} title={name} key={name}><SocialIcon name={name}/></a>)}</nav><a className="pct-header-cta" href="#enquire">Talk to an expert</a></div></header>
