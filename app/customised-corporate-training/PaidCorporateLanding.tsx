...
export default function PaidCorporateLanding({courses}:Props){
  ...
  return <main className="pct-page">
    <header className="pct-header"><Link href="/" aria-label="Entrepôt Training Institute home"><img src="/entrepot-logo-transparent.png" alt="Entrepôt Training Institute"/></Link><div><a href="tel:+971544177480">+971 544 177480</a><a className="pct-header-cta" href="#enquire">Talk to an expert</a></div></header>
    ...
    <footer className="pct-footer"><img src="/entrepot-logo-transparent.png" alt="Entrepôt Training Institute"/><div className="pct-footer-details"><div className="pct-footer-contact"><span>Dubai · Mumbai</span><a href="tel:+971544177480">+971 544 177480</a><a href="tel:+971545353558">+971 545 353 558</a><a href="mailto:courses@entrepot.ae">courses@entrepot.ae</a></div><nav className="pct-socials" aria-label="Entrepôt social media">{socialLinks.map(([name,url])=><a href={url} target="_blank" rel="noopener noreferrer" key={name}>{name}</a>)}</nav><span>© 2026 Entrepôt Training Institute</span></div></footer>
