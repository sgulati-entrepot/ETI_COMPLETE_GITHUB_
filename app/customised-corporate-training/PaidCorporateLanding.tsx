...
export default function PaidCorporateLanding({courses}:Props){
  ...
  return <main className="pct-page">
    ...
    <section className="pct-training-gallery" aria-labelledby="pct-facilitation-gallery-title"><div className="pct-training-gallery-head"><div><span>Training gallery / Overseas corporate delivery</span><h2 id="pct-facilitation-gallery-title">Facilitation in Air<br/><em>Transportation Handling.</em></h2></div><div><strong>Successfully completed</strong><p>We are proud to have successfully completed an overseas batch of Facilitation in Air Transportation Handling for one of our esteemed corporate clients.</p></div></div><div className="pct-training-gallery-grid">{facilitationGallery.map((photo,index)=><figure className={`pct-training-gallery-photo pct-training-gallery-photo-${index+1}`} key={photo.image}><img src={optimizedImage(photo.image,index===0||index===4?1200:760,82)} alt={photo.alt} loading="lazy" decoding="async"/><figcaption><span>{String(index+1).padStart(2,"0")}</span>{photo.caption}</figcaption></figure>)}</div></section>
    <section className="pct-training-gallery pct-training-gallery-light" aria-labelledby="pct-overseas-corporate-gallery-title"><div className="pct-training-gallery-head"><div><span>Training gallery / International delivery</span><h2 id="pct-overseas-corporate-gallery-title">Overseas Corporate<br/><em>Training.</em></h2></div><div><strong>Successfully completed</strong><p>We are proud to have successfully completed an overseas corporate training batch for one of our esteemed corporate clients.</p></div></div><div className="pct-training-gallery-grid pct-overseas-corporate-grid">{overseasCorporateGallery.map((photo,index)=><figure className={`pct-training-gallery-photo pct-training-gallery-photo-${index+1}`} key={photo.image}><img src={optimizedImage(photo.image,index===0||index===1?1200:760,82)} alt={photo.alt} loading="lazy" decoding="async"/><figcaption><span>{String(index+1).padStart(2,"0")}</span>{photo.caption}</figcaption></figure>)}</div></section>
    <section className="pct-training-gallery" aria-labelledby="pct-financial-consultants-auditors-gallery-title"><div className="pct-training-gallery-head"><div><span>Training gallery / Corporate learning</span><h2 id="pct-financial-consultants-auditors-gallery-title">Financial Consultants<br/><em>&amp; Auditors.</em></h2></div><div><strong>Successfully completed</strong><p>We are proud to have successfully completed a corporate training batch for financial consultants and auditors from one of our esteemed corporate clients.</p></div></div><div className="pct-training-gallery-grid pct-financial-gallery-grid">{financialConsultantsAuditorsGallery.map((photo,index)=><figure className={`pct-training-gallery-photo pct-training-gallery-photo-${index+1}`} key={photo.image}><img src={optimizedImage(photo.image,1200,84)} alt={photo.alt} loading="lazy" decoding="async"/><figcaption><span>{String(index+1).padStart(2,"0")}</span>{photo.caption}</figcaption></figure>)}</div></section>
